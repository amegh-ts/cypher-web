  ...
  return (
    <div>
      <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <Card className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md backdrop-blur-md bg-white/5 border border-white/10 shadow-2xl rounded-2xl animate-fade-in">
